   			...
   			<div class="row">
   				<div>
   					<table class="table" >
   						...
   						<tbody>
   						<c:forEach var="value1" items="${danhsachchitiethoadons }">
   							<tr>
   								<td >${value1.getSoluong() } </td>
   								<td>${value1.getGiatien() }</td>
   								<td><a href="<c:url value="/chitiethoadon2/${value1.getChitiethoadonid().getMachitietsanpham() }" />">Chi tiết</a></td> 
   							</tr>
   						</c:forEach> 
   						</tbody>
