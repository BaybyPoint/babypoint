   			...
   			<div class="row">
   				<div class="col-md-6 col-sm-6">
   					<table class="table"  >
   						<thead>
   							<tr >
   								<td style="color: #00ff43;">Mã sản phẩm</td>
   								<td style="color: #004eff;">Mã size </td>
   								<td style="color: red;">Mã màu </td>
   							</tr>
   						</thead>
   						
   						<tbody>
   						<c:forEach var="value1" items="${sanphamtheomachitiet }">
   							<tr>
   								<td style="color: #00ff43;"><a href=" <c:url value="/chitiet/${value1.getSanpham().getMasanpham() }"  /> ">${value1.getSanpham().getMasanpham() }</a> </td>
   								<td style="color: #004eff;">${value1.getSizesanpham().getMasize() }</td>
   								<td style="color: red;">${value1.getMausanpham().getMamau() }</td>
   							</tr>
   						</c:forEach> 
   						</tbody>
   				...
   				<div class="col-md-3 col-sm-3">
   					<table class="table" >
   						...
   						<tbody>
   						<c:forEach var="value1" items="${danhsachsizesanpham }">
   							<tr>
   								<td >${value1.getMasize() } </td>
   								<td>${value1.getSize() }</td>
   							</tr>
   						</c:forEach> 
   						</tbody>
   					</table>
   				...
   				<div class="col-md-3 col-sm-3">
   					<table class="table" >
   						...
   						<tbody>
   						<c:forEach var="value1" items="${danhsachmausanpham }">
   							<tr>
   								<td>${value1.getMamau() }</td>
   								<td>${value1.getTenmau() }</td>
   							</tr>
   						</c:forEach> 
   						</tbody>
   					</table>
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="errorpage.html"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>Find Code</span><div class="clearfix"></div></a></li>
