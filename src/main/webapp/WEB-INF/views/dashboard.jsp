                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="<c:url value="/"/>"><i class="fa fa-tachometer"></i> <span>Home</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href="<c:url value="/themsanpham"/>"><i class="fa fa-cube nav_icon" aria-hidden="true"></i><span>Product</span><div class="clearfix"></div></a></li>
