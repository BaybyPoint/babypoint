   			...
   			<div class="row">
   				<div>
   					<table class="table" >
   						...
   						<tbody>
   						<c:forEach var="value" items="${danhsachhoadon }">
   							<tr>
   								<td>${value.getMahoadon() }</td>
   								<td data-value="${value.getMahoadon() }">${value.getTenkhachhang() }</td>
   								<td>${value.getSodt() }</td>
   								<td>${value.getDiachigiaohang() }</td>
   								<td>${value.getHinhthucgiaohang() }</td>
   								<td>${value.getGhichu() }</td>
   								<td><a href="<c:url value="/chitiethoadon/${value.getMahoadon()}" />" >Chi tiết</a></td>
   								<td><button id="xoahoadon" class="btn btn-danger">XÓA </button></td>
   							</tr>
   						</c:forEach>
   						</tbody>
