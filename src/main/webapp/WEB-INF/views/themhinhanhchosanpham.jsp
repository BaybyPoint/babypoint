...
<body>
   <div class="page-container">
   		<div class="left-content">
   			<div class="row">
   				<div>
                    <form action="" id="form-hinhsanphamthem">

                       <label for="masanphamthem">Mã sản phẩm</label><br/>
                       <input id="masanphamthem" class="form-control" name="masanphamthem" type="text" placeholder="Nhập vào mã sản phẩm" />

                       <br/><label for="themhinhanh">Hình ảnh</label><br/>
                       <input id="themhinhanh" class="form-control" type="file" name="themhinhanh" />
                    </form>
   				</div>
